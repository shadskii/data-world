 ...
 */
export type CountryCode3 = typeof countries[number]["alpha-3"];

/**
 * ISO 3166-1 alpha-2 country codes.
 * https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2
 */
export type CountryCode2 = typeof countries[number]["alpha-2"];

/**
 * Gets the country name for a given country code.
 *
 * @param cc3 ISO 3166-1 alpha-3 country code
 * @returns The country name or undefined if not found.
 */
export function getCountryName(cc3: CountryCode3): string {
  return countries.find((c) => c["alpha-3"] === cc3)?.name ?? "N/A";
}

/**
 * Convets a ISO 3166-1 alpha-3 country code to a ISO 3166-1 alpha-2 country code.
 *
 * @param cc3 ISO 3166-1 alpha-3 country code
 * @returns The ISO 3166-1 alpha-2 country code or undefined if not found.
 */
export function convertTo2(cc3: CountryCode3): CountryCode2 | undefined {
  return countries.find((c) => c["alpha-3"] === cc3)?.["alpha-2"];
}

/**
 * Converts a ISO 3166-1 alpha-2 country code to a ISO 3166-1 alpha-3 country code.
 *
 * @param cc2 ISO 3166-1 alpha-2 country code
 * @returns The ISO 3166-1 alpha-3 country code or undefined if not found.
 */
export function convertTo3(cc2: CountryCode2): CountryCode3 | undefined {
  return countries.find((c) => c["alpha-2"] === cc2)?.["alpha-3"];
}

/**
 * Country data I found here https://developers.google.com/public-data/docs/canonical/countries_csv
 */
const countries = [
  {
    name: "Afghanistan",
